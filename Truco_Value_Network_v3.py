...
class ValueNetworkEngine:
    ...
    def Generate_Player_DVN():
        ...
        player_DVN.add(layers.Dense(50, activation='relu', input_shape=(50,)))
        player_DVN.add(layers.Dense(80, activation='relu', kernel_regularizer=keras.regularizers.l2(0.01)))
    ...
    def ValueNetworkTrainer(start_gen, generations, games_per_gen, load_previous=False):
        ...
        for i in range(start_gen, start_gen+generations):
            ...
            if i == 0:
                ValueNetworkEngine.Train_Save(gen_next, 50, False)
            else:
                ValueNetworkEngine.Train_Save(gen_next, 50, load_previous)
