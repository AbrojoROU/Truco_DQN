...
def Train_Save(nameprefix, batch_size, epochs, DEBUG):
    ...
    # Fiteo la red
    p1_DQN.fit(p1_traindata, p1_trainlabels, epochs=2, batch_size=128, shuffle=True)
    ...
    # Fiteo la red
    p2_DQN.fit(p2_traindata, p2_trainlabels, epochs=2, batch_size=128, shuffle=True)
...
if __name__ == '__main__':
    ...
    tf.logging.set_verbosity(tf.logging.ERROR)  # esta linea deshabilita algunos warnings de tensorflow, quedan algunos
